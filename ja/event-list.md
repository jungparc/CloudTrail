...
|プロジェクト間のピアリングを作成|event_id.iaas.project_peering.create|基本インフラサービス|
|プロジェクト間のピアリングを変更|event_id.iaas.project_peering.update|基本インフラサービス|
|プロジェクト間のピアリングを削除|event_id.iaas.project_peering.delete|基本インフラサービス|
