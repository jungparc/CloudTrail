...
|수신거부 사용자 제거|event_id.email.event_id.email.remove_block_receiver|Email|
...
|수신거부 서비스 추가|event_id.email.add_block_service|Email|
...
|수신거부 서비스 제거|event_id.email.event_id.email.remove_block_service|Email|
