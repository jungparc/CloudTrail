...
* NHN Cloud (공공기관용) memberType일 경우, emailAddress의 값은 필수이고, userCode의 값은 존재하지 않아야 합니다. 
...
* 이벤트 ID에 대한 자세한 정보는 매뉴얼을 참고합니다 : [링크](https://docs.gov-nhncloud.com/ko/CloudTrail/ko/event-list-gov/)
